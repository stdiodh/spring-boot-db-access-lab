window.visualLabData = {
  ...
  "codePoints": [
    ...
    },
    {
      ...
      "explanation": "이 Step의 구현 목표는 기존 외부 identity를 먼저 재사용하고 같은 email의 다른 계정을 명시적인 연결 확인 없이 합치지 않는 것입니다.",
    ...
    },
    {
      ...
      "explanation": "이 Step의 구현 목표는 요청 email 대신 JWT Principal로 사용자를 잠그고 최초 등록만 허용하는 것입니다. authProvider와 providerId를 유지하므로 Google 재로그인도 계속됩니다.",
    ...
    },
    {
      ...
      "title": "완성 뒤 token commit을 거쳐 mail command를 반환합니다",
      ...
      "explanation": "이 Step의 구현 목표는 DB에 hash를 commit하고 raw token이 든 link를 transaction 밖의 동기 SMTP 호출에 넘기는 것입니다.",
    ...
    },
    {
      ...
      "explanation": "이 Step의 구현 목표는 Gmail에서 인증 username을 From으로 사용하고, Mailpit 등 다른 SMTP에서는 별도 발신자 설정을 사용하는 것입니다. 빈 Gmail username 오류에는 실제 주소와 secret을 넣지 않습니다.",
