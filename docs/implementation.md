...
- `05`: 동기화된 두 05 브랜치에서 Step01 profile 검증부터 Step06 SMTP adapter까지 읽습니다. Google identity와 선택적 LOCAL 자격을 분리하고, token commit 뒤 동기 SMTP 결과가 `200/422/429/424`로 갈리는 경계를 테스트로 확인합니다.
