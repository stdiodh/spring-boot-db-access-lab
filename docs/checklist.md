...
- [ ] `05`: `05-implementation`의 6개 Step 파일에 있는 7개 TODO 메서드 본문을 구현했습니다.
- [ ] `05`: 7개 TODO 본문 외의 production 로직과 테스트가 `05-answer`와 같은지 확인했습니다.
...
- [ ] `05`: Gmail은 `SPRING_MAIL_USERNAME`, 그 밖의 SMTP는 `APP_RECOVERY_MAIL_FROM`을 From으로 사용하는지 확인했습니다.
